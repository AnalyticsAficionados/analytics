(function()  {
		...
		<form id="form">
			<fieldset>
				...
				<table>
					<tr>
						<td>Title</td>
						<td><input id="bps_title" type="text" size="100" maxlength="200"></td>
					</tr>
					<tr>
						<td>Sub Title</td>
						<td><input id="bps_subtitle" type="text" size="100" maxlength="200"></td>
					</tr>
					<tr>
						<td>min</td>
						<td><input id="bps_min" type="text" size="100" maxlength="10"></td>
					</tr>
					<tr>
						<td>max</td>
						<td><input id="bps_max" type="text" size="100" maxlength="10"></td>
					</tr>
				</table>
	...
	customElements.define("com-fd-scatter-bps", BoxBps);
})();
